        ...
        <div class="max-w-4xl mx-auto p-8 lg:p-12">
            ...
            <header class="flex items-center justify-between gap-8 mb-12">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Nuevo Grupo</h1>
                        <p class="text-sm text-slate-500 font-medium mt-1">Defina el nombre del grupo y asigne un asesor responsable.</p>
                    </div>
                </div>
            </header>
